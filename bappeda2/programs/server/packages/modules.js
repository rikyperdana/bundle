...
install("url");
install("http");
install("baberuth22:google-geocode");
install("appshore:leaflet-awesome-markers");
install("fortawesome:fontawesome");
install("herrhelms:meteor-leaflet-locatecontrol");
install("planettraining:material-design-icons-font");
install("izzilab:shelljs");
install("materialize:materialize");
install("outatime:geolib");
install("livedata");
...
module.exports = {
  ...
  "_where": "/home/riky/Meteor/bappeda",
  "author": {
