...
var require = meteorInstall({"node_modules":{"meteor":{"modules":{"server.js":["./install-packages.js","./process.js","./reify.js",function(require){
...
install("selaias:accounts-entry");
install("matdutour:popup-confirm");
