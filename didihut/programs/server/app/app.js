...
if (Meteor.isClient) {
  this.elem = {
    modal: function(arg$){
      var title, content, confirm, action, that;
      title = arg$.title, content = arg$.content, confirm = arg$.confirm, action = arg$.action;
      return m('.modal.is-active', m('.modal-background'), m('.modal-card', m('header.modal-card-head', m('p.modal-card-title', title), m('button.delete', {
        'aria-label': 'close',
        onclick: function(){
          return state.modal = null;
        }
      })), (that = content) ? m('section.modal-card-body', m('.content', that)) : void 8, m('footer.modal-card-foot', confirm ? m('button.button.is-success', {
        onclick: function(){
          return typeof action == 'function' ? action() : void 8;
        }
      }, m('span', confirm)) : void 8)));
    },
    pagins: function(arr){
