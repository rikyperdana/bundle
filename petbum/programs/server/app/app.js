        ...
        return arr = [
          {
            ...
            head: 'Diagnosa',
            cell: doc != null ? doc.diagnosa.join(', ') : void 8
          }, {
            head: 'Planning',
    ...
    pasien: function(){
      return {
        view: function(){
          ...
          return m('.content', userGroup('regis') ? elem.report({
...
if (Meteor.isServer) {
  ...
  Meteor.methods({
    ...
    visits: function(start, end){
      ...
      return selects.klinik.map(function(i){
        return {
          KLINIK: i.label,
          JUMLAH: function(it){
            return (it != null ? it.jumlah : void 8) || 0;
          }(groups.find(function(it){
            return it._id === i.value;
          }))
        };
      });
    },
